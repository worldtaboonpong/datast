...
# def __init__(self,dataframe,col_val_selector):
#     self.dataframe = dataframe
#     self.col_val_selector = col_val_selector
...
def getanswer(df,ip):
    ...
    answer=str(back[decisiontree(Dataframe,Target,Input.values.tolist())])
...
# # df2 = pd.read_excel('test_files/MRTuser.xlsx')
...
# df_after_clean2 = cleanDataframe(df2)
# dict2 = {'โครงการ': 'โครงการรถไฟฟ้ามหานคร สายฉลองรัชธรรม', 'จำนวนผู้โดยสารรวม': 'ช่วง 1033190 ถึง 1231255', 'จำนวนผู้โดยสารเฉลี่ยรายวัน': 'ช่วง 14640 ถึง 20972', 'จำนวนผู้โดยสารเฉลี่ยรายวันหยุด': 'ช่วง 11956 ถึง 17115'}
# print(DecisionTree.getanswer(df_after_clean2,dict2))